...
<div class="email-container">
    <!-- Header -->
    <div class="header">
        <img src="https://www.automationecom.store/en/logo.svg" alt="Company Logo">
    </div>
    ...
    <div class="footer">
        ...
        <div class="social-links">
            <img src="https://www.automationecom.store/en/icons-social.webp" alt="socials" height="50px" />
        </div>
        <p>
