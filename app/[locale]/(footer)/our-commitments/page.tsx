      ...
      <section className="space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              We are deeply committed to offering the highest quality products,
              sourced from some of the most respected names in the industry. Our
              partnerships with Siemens, Schneider, DEIF, and ComAp ensure that
              our customers receive durable, high-performance equipment.
            </p>
            <p>
              We are constantly expanding our product offerings to include the
              latest Industry 4.0 technologies, including IoT-based solutions,
              remote monitoring, predictive maintenance, and advanced automation
              systems.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              products—such as S7-1200, S7-1500, and S7-300 PLCs—is a testament
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              Our team of experienced engineers and automation specialists work
              closely with clients to understand their unique challenges and
              tailor solutions that best meet their operational goals.
            </p>
            <p>
              We provide guidance on installation, commissioning, and
              maintenance, ensuring that every solution we deliver is optimized
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              delivery of products worldwide, ensuring that businesses across
              various geographies can benefit from our automation solutions.
            </p>
            <p>
              We offer localized support to ensure that customers receive the
              assistance they need in their specific markets, from localized
              customer service teams to region-specific product recommendations.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              product offerings include energy-efficient automation systems that
              not only optimize production but also minimize environmental
              impact.
            </p>
            <p>
